...
class DecisionTraceService:
    ...
    async def explain_decision(
        ...
        for feature, importance in sorted_features:
            explanations.append({
                ...
                "percentage": (abs(importance) / total_contribution * 100) if total_contribution > 0 else 0,
    ...
    async def get_trace_by_entity(
        self,
        entity_id: str,
        limit: int = 50
    ) -> List[DecisionTrace]:
        """Get decision traces for an entity"""
