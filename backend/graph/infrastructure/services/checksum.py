"""
Graph Infrastructure - Canonical Checksum Service

Computes deterministic checksum from canonical representation.
Used for persistence integrity verification.
"""
...
class CanonicalChecksumService:
    """
    Canonical Checksum Service - Infrastructure.
    ...
    def compute_from_aggregate(self, aggregate: GraphAggregate) -> str:
        ...
        canonical = self._to_canonical_from_aggregate(aggregate)
    ...
    def _to_canonical_from_aggregate(self, aggregate: GraphAggregate) -> Dict[str, Any]:
