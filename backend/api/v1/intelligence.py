# backend/api/v1/intelligence.py - Intelligence Router (NO PREFIX)
...
# ============================================
# ROUTER - TANPA PREFIX (di handle di __init__)
# ============================================
...
async def calculate_risk_score(
    ...
    fraud_score: Optional[float] = Query(0, description="Fraud score"),
