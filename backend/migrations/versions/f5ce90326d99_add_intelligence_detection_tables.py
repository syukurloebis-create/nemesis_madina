...
def upgrade() -> None:
    ...
    sa.Column('detection_type', sa.Enum('STATISTICAL', 'GRAPH', 'ML', 'RULE', 'TEMPORAL', name='detectiontype'), nullable=False),
    ...
    sa.Column('status', sa.Enum('PENDING', 'ACKNOWLEDGED', 'RESOLVED', 'DISMISSED', name='alertstatus'), nullable=True),
